...
## Operacion con Docker local

`init-db.sh` usa scripts de `manual/` y respeta `SEED_TEST_DATA`:

- `false` (default): no inserta datos de prueba.
- `true` o `1`: ejecuta `manual/02_InsertTestData.sql`.
