-- =============================================================================
-- Migracion incremental: columna MostrarEnCv en Habilidad
-- =============================================================================
-- INSTRUCCIONES:
...
IF NOT EXISTS (
    ...
    WHERE object_id = OBJECT_ID(N'dbo.Habilidad') AND name = N'MostrarEnCv'
)
BEGIN
    ALTER TABLE dbo.Habilidad ADD MostrarEnCv BIT NOT NULL CONSTRAINT DF_Habilidad_MostrarEnCv DEFAULT 1;
    PRINT 'Columna dbo.Habilidad.MostrarEnCv agregada.';
END
ELSE
BEGIN
    PRINT 'Columna dbo.Habilidad.MostrarEnCv ya existe, no se realizaron cambios.';
END
GO
