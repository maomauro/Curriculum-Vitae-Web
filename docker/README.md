...
| Imagen frontend — desarrollo (hot-reload) | `frontend/Dockerfile.dev` | Solo para `docker compose up`. No existe imagen de producción del frontend: se despliega a Azure Static Web Apps como build estático. |
